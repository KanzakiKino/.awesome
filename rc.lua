...
systemmenu = {
    { "Shortcuts", function() return false, hotkeys_popup.show_help end },
    { "Relogin"  , awesome.restart },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "A1", "A2", "B1", "B2", "C1", "C2", "D1", "D2" }, s, awful.layout.layouts[1])
